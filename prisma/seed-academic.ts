...
- การฟังธรรมบรรยายและธรรมปฏิบัติเชิงลึก`,
  ...
  const facultyMembers = [
    ...
    },
    {
      ...
      academicRank: "รศ.ดร.",
      firstNameTh: "ยุทธนา",
      monasticName: "นรเชฏฺโฐ",
      monasticRank: "เปรียญธรรม ๙ ประโยค (ป.ธ.๙)",
      templeName: "วัดมหาธาตุยุวราชรังสฤษฎิ์ กรุงเทพฯ",
      positionTh: "ประธานหลักสูตร / หัวหน้าภาควิชาพระพุทธศาสนา คณะพุทธศาสตร์",
      isVipassanaMaster: true,
      isExecutive: true,
      expertise: "พระไตรปิฎกศึกษา, พระพุทธศาสนาเถรวาท, วิปัสสนาภาวนา",
      avatarUrl: "https://fb.mcu.ac.th/wp-content/uploads/2026/03/PmYuttana6901.png",
      sortOrder: 3,
    },
    {
      titleTh: "พระครูภาวนาวัฒนบัณฑิต วิ.",
      academicRank: "ผศ.ดร.",
      firstNameTh: "เจริญ",
      monasticName: "วฑฺฒโน",
      monasticRank: "พระครูสัญญาบัตรวิปัสสนาธุระ",
      templeName: "วัดแนบทวีพราราม / วัดยานนาวา",
      positionTh: "กรรมการและเลขานุการหลักสูตร / พระวิปัสสนาจารย์",
      isVipassanaMaster: true,
      isExecutive: true,
      expertise: "สติปัฏฐาน ๔, การสอบอารมณ์วิปัสสนากรรมฐาน, วิสุทธิมรรค",
      avatarUrl: "https://fb.mcu.ac.th/wp-content/uploads/2026/04/951813001_09.png",
      sortOrder: 4,
    },
    {
      titleTh: "พระมหา",
      ...
      avatarUrl: "https://fb.mcu.ac.th/wp-content/uploads/2026/03/yongyut6901.png",
      sortOrder: 5,
    },
    {
      titleTh: "นาย",
      ...
      monasticRank: null,
      templeName: null,
      positionTh: "อาจารย์ผู้รับผิดชอบหลักสูตร / รองหัวหน้าภาควิชาพระพุทธศาสนา",
      isVipassanaMaster: false,
      isExecutive: false,
      expertise: "ปรัชญาพระพุทธศาสนา, จริยศาสตร์เชิงพุทธ, พระไตรปิฎกศึกษา",
      avatarUrl: "https://fb.mcu.ac.th/wp-content/uploads/2026/03/AccSutep6901.png",
      sortOrder: 6,
    },
    {
      titleTh: "พระมหา",
      academicRank: "ดร.",
      firstNameTh: "ราชัน",
      monasticName: "จิตฺตปาโล",
      monasticRank: "เปรียญธรรม, พธ.ด.",
      templeName: "มหาวิทยาลัยมหาจุฬาลงกรณราชวิทยาลัย",
      positionTh: "อาจารย์ผู้รับผิดชอบหลักสูตร / ผู้ช่วยอธิการบดีฝ่ายกิจการนิสิต",
      isVipassanaMaster: true,
      isExecutive: true,
      expertise: "พระพุทธศาสนาเถรวาท, ธรรมนิเทศ, การพัฒนาจิตตภาวนา",
      avatarUrl: "https://fb.mcu.ac.th/wp-content/uploads/2026/03/a3PmRashun6901.png",
      sortOrder: 7,
    },
    {
  ...
  await prisma.facultyMember.deleteMany({ where: { tenantId } });
