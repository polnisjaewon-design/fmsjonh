...
export { resolvePalette, getTenantPalette, getTenantSettings, getDefaultTenantId, resolveTenantSettings, getTenantSmtp, getTenantGemini, type TenantSettings } from "./_internal/services/tenant.service";
export type { SmtpSettings, OrgInfo, GeminiSettings } from "./_internal/validations/settings";
